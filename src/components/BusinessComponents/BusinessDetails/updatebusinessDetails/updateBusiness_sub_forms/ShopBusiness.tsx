...
const ShopBusiness: React.FC<Props> = ({ selected: { shop } }: Props) => {
  ...
  return (
    <>
      {shop === "shop" ? (
              ...
              <div className="contab_tab_inner_right_address">
                <>
                  <div className="step2_page_tab_pane_right updBusDetail_right">
                    {/* <Field
                      name={`contactdetails.shop.address`}
                      placeholder="Search Address"
                      component={AddressLookup}
                      disabled={addressToggle}
                      calledFrom="updateshopbusiness"
                      id={"updateshopbusiness"}
                    />
        ...
        <h4>
          Please click on checkbox to update the tab content of shop business
        </h4>
      )}
    </>
  );
