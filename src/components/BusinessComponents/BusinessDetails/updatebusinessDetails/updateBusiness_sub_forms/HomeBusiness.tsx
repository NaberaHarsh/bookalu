...
const HomeBusiness: React.FC<Props> = ({ selected: { home } }: Props) => {
  ...
  return (
    <>
      {home === "home" ? (
          ...
          <Col sm={12} md={6}>
            <div className="OpnningTimesMain">
              ...
              <div className="updatebusiness_openingtime">
                <FieldArray name={`openingtimes.homebusiness`}>
                  {({ fields }) => {
                    return (
                      <>
              ...
              <div className="contab_tab_inner_right_address">
                <>
                  <div className="step2_page_tab_pane_right updBusDetail_right">
                    {/* <Field
                      name={`contactdetails.homebusiness.address`}
                      placeholder="Search Address"
                      component={AddressLookup}
                      disabled={addressToggle}
                      calledFrom="updatehomebusiness"
                      id={"updatehomebusiness"}
                    />
        ...
        <h4>
          Please click on checkbox to update the tab content of home business
        </h4>
      )}
    </>
  );
