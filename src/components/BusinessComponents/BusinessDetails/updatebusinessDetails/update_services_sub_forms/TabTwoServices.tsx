...
const TabTwoServices: React.FC<Props> = ({
  tabTwoInitailD,
  addLineBreak,
  removeLineBreak,
  removeService,
  ...
  return (
    <div>
              ...
              <>
                ...
                <div className="step6_page_tab_pane_item2">
                  ...
                  <div className="step6_page_tab_pane_item2_inner">
                    <FieldArray
                      name={`services.tabTwo.subservices`}
                            ...
                            <button
                              ...
                              onClick={() =>
                                fields.push({
                                  ...
                                  id: "",
                                  appoinmentvia:
                                    tabTwoInitailD.subservices[0].appoinmentvia,
                                  appoinmentviastring:
                                    tabTwoInitailD.subservices[0]
                                      .appoinmentviastring,
                                  haslinebreak: false,
                                })
                              }
      ...
      // )} */}
        ...
        <h4>Please select tab two checkbox to update services</h4>
      )}
