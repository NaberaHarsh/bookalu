...
const TabOneServices: React.FC<Props> = ({
  tabOneInitailD,
  addLineBreak,
  removeLineBreak,
  removeService,
  ...
  return (
    <div>
      {tabSelected ? (
                          ...
                          <>
                            ...
                            <div className="page6_tab_pane_bottom_area_inner2">
                              ...
                              <OverlayTrigger
                                ...
                                overlay={
                                  <Tooltip id={`tooltip-right`}>
                                    Add a Line break to Specify different
                                    service
                                  </Tooltip>
                                }
                              >
        ...
        <h4>Please select Tab One checkbox to add service</h4>
      )}
      {/*--- page_link_area End-----*/}
    </div>
  );
