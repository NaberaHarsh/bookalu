...
// import { Porps } from "../../../commonComponents/Popups/ResendVerifyLink";
...
const HomeContactDetails: React.FC<Props> = ({ homeBusiness }: Props) => {
  const { contactdetails, openingtimes } = homeBusiness;
