...
const AddressLookup: React.FC<Props> = ({
  ...
  useEffect(() => {
    const inputField = document.getElementById(rest.id) as any;
    // console.log(input);
    ...
    autocomplete.addListener("place_changed", () => {
      ...
      if (place) {
        ...
        if (rest.calledFrom) payload.calledFrom = rest.calledFrom;
...
//         payload.streetNum = place.address_components[i].long_name;
//       }
//       if (place.address_components[i].types[j] === "route") {
//         payload.addressLine1 = place.address_components[i].long_name;
//       }
